...
"}"));
        ...
        pushButton_FastInstall = new QPushButton(page);
        pushButton_FastInstall->setObjectName(QString::fromUtf8("pushButton_FastInstall"));
        pushButton_FastInstall->setGeometry(QRect(10, 70, 451, 64));
...
"                            }\n"
"                        "));
        label_FastInstall_Icon = new QLabel(page);
        label_FastInstall_Icon->setObjectName(QString::fromUtf8("label_FastInstall_Icon"));
        label_FastInstall_Icon->setGeometry(QRect(110, 86, 16, 14));
...
""));
        ...
        checkBox_desktopShortcut->setFont(font5);
        ...
        checkBox_startMenuShortCut->setFont(font5);
...
"                        "));
        ...
        label_CustomizeInstall_Icon->setGeometry(QRect(100, 16, 16, 14));
...
"                        "));
        ...
        label_CustomizeInstall->setFont(font1);
...
"                        "));
        ...
        label_FastInstall_Icon->raise();
        label_FastInstall->raise();
        label_FastInstall_Documentation->raise();
        label_Wizard_0->raise();
        label_Tag_Down->raise();
        label_Readme->raise();
        pushButton_FastInstall->raise();
        label_Tag_Up->raise();
        widget_CustomOption->raise();
        widget_CustomButtom->raise();
        page_2 = new QWidget();
...
"                        "));
        ...
        label_Documentation->setGeometry(QRect(115, 52, 250, 40));
...
"                        "));
        ...
        label_Icon_0->setMinimumSize(QSize(38, 38));
        label_Icon_0->setMaximumSize(QSize(38, 38));
...
"                                    "));
        ...
        label_Icon_1->setMinimumSize(QSize(38, 38));
        label_Icon_1->setMaximumSize(QSize(38, 38));
...
"\347\232\204\347\244\276\344\272\244\350\264\246\345\217\267\357\274\232\n"
"                        ", nullptr));
